...
export default function Edit() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await fetch(
        `https://node-routes-ijwz.onrender.com/students/${params.id.toString()}`
      );
  ...
  async function onSubmit(e) {
    ...
    await fetch(`https://node-routes-ijwz.onrender.com/students/${params.id}`, {
      method: "PUT",
  ...
  return (
    <div>
      <h3 className="update">Update Record</h3>
